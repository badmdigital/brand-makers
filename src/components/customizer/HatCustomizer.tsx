    ...
    const handleSubmit = async () => {
        ...
        try {
            const payload = {
                ...
                structure: store.selectedStructure,
                fabric: store.selectedFabric,
                bill: store.selectedBill,
                closure: store.selectedClosure,
                frontDecoLocation: store.frontDecoLocation,
                frontDecoType: store.frontDecoType,
                secondDecoLocation: store.secondDecoLocation,
                secondDecoType: store.secondDecoLocation.id === 'none' ? null : store.secondDecoType,
            };
